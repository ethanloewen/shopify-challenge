...
export default function Form(props) {
  ...
  const setPrompt = () => {
    const prompts = ['How far away is the moon?', 'Write me a song about a tree', 'How old is the earth?', 'Pick a number between 1 and 100', 'What time is it in Japan?', 'Pick a username for me to use online', 'When is the next solar eclipse?', 'What is the legal drinking age in Spain?'];
